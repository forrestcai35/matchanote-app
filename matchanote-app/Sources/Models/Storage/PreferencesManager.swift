...
class PreferencesManager: ObservableObject {
    ...
    private enum DefaultsKeys {
        ...
        static let assistantDraggableBlocks = "preferences.assistant.draggableBlocks"
        ...
        static let homeViewIsGridView = "preferences.homeView.isGridView"
        static let homeViewSortOption = "preferences.homeView.sortOption"

        // Study Mode Preferences
        static let quizShowAnswerImmediately = "preferences.quiz.showAnswerImmediately"
    ...
    @Published var assistantDraggableBlocks: Bool {
        didSet {
            userDefaults.set(assistantDraggableBlocks, forKey: DefaultsKeys.assistantDraggableBlocks)
        }
    }
    ...
    // MARK: - Study Mode Preferences
    @Published var quizShowAnswerImmediately: Bool {
        didSet {
            userDefaults.set(quizShowAnswerImmediately, forKey: DefaultsKeys.quizShowAnswerImmediately)
        }
    }

    // MARK: - Home View Preferences
    @Published var homeViewIsGridView: Bool {
        didSet {
            userDefaults.set(homeViewIsGridView, forKey: DefaultsKeys.homeViewIsGridView)
        }
    }

    @Published var homeViewSortOption: String {
        didSet {
            userDefaults.set(homeViewSortOption, forKey: DefaultsKeys.homeViewSortOption)
        }
    }
    ...
    private init() {
        ...
        // Load saved draggable blocks preference or default to true (enabled)
        self.assistantDraggableBlocks = userDefaults.object(forKey: DefaultsKeys.assistantDraggableBlocks) as? Bool ?? true
        ...
        self.quizShowAnswerImmediately = userDefaults.object(forKey: DefaultsKeys.quizShowAnswerImmediately) as? Bool ?? true

        // Load home view preferences
        self.homeViewIsGridView = userDefaults.object(forKey: DefaultsKeys.homeViewIsGridView) as? Bool ?? true
        self.homeViewSortOption = userDefaults.string(forKey: DefaultsKeys.homeViewSortOption) ?? "Date"
