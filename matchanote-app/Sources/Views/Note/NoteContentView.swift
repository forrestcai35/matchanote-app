...
struct WrittenNoteView: View {
                ...
                .background {
                    GeometryReader { _ in
                        ZStack(alignment: .topLeading) {
                            ...
                            // Canvas overlays (images, textboxes)
                            CanvasImageOverlay(
                                imageManager: imageManager,
                                pageIndex: pageIndex,
                                canvasSize: perPageSize(pageIndex)
    ...
    // MARK: - Lossless Canvas Container (Simplified with Native Scrolling)
    ...
    struct LosslessCanvasContainer: UIViewRepresentable {
        ...
        func makeUIView(context: Context) -> UIView {
            ...
            // Configure PKCanvasView with native scrolling/zooming enabled
        ...
        func updateUIView(_ uiView: UIView, context: Context) {
            ...
            // Minimal updates - let PKCanvasView handle its own state
        }
